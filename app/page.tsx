...
export default function HomePage() {
  return (
    <>
            ...
            review: [
              {
                ...
                reviewBody: 'Uitstekende service! Altijd op tijd en de Tesla is heerlijk comfortabel.',
              },
              {
                '@type': 'Review',
                reviewRating: {
                ...
                reviewBody: 'Top service naar Schiphol. Chauffeur was vriendelijk en de auto was schoon.',
              },
            ],
          }),
        }}
                  ...
                  <div className="bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-lg">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="text-sm font-semibold text-secondary-900">Luchthaven Service</div>
                          <div className="text-xs text-secondary-500">Flight tracking & Meet & Greet</div>
                        </div>
                      </div>
        ...
        <div className="container-custom relative z-10">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 mb-6">
              <span className="text-sm font-semibold text-white uppercase tracking-wider">Hoe Werkt Het</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
              In <span className="text-primary-400">4 Stappen</span> Geboekt
            </h2>
              ...
              <div key={index} className="relative group">
                ...
                {index < processSteps.length - 1 && (
                  <div className="hidden lg:block absolute top-10 left-[60%] w-[80%] h-0.5">
                    <div className="w-full h-full bg-gradient-to-r from-primary-500/50 to-transparent" />
                    <div className="absolute right-0 top-1/2 -translate-y-1/2 w-2 h-2 bg-primary-500/50 rounded-full" />
                  </div>
                )}

                {/* Card */}
                <div className="relative bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all duration-300 h-full">
                  {/* Step number */}
                  <div className="relative inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-primary-400 to-primary-600 text-white text-2xl font-bold mb-6 shadow-lg shadow-primary-500/30 group-hover:scale-110 transition-transform duration-300">
                    {item.step}
                    {/* Glow effect */}
                    <div className="absolute inset-0 rounded-2xl bg-primary-400 blur-xl opacity-0 group-hover:opacity-50 transition-opacity duration-300" />
                  </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-16">
            <a
              href="tel:+31612345678"
              className="inline-flex items-center justify-center px-8 py-4 font-semibold text-primary-900 bg-white rounded-xl hover:bg-primary-50 transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5"
            >
              <svg className="w-5 h-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
              </svg>
              Bel Nu: +31 6 1234 5678
            </a>
            <a
              href="https://wa.me/31612345678"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center px-8 py-4 font-semibold text-white bg-green-600 rounded-xl hover:bg-green-700 transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5"
            >
      ...
      {/* Locations Section - Modern Design */}
      <section className="relative py-24 bg-gradient-to-br from-primary-900 via-primary-800 to-secondary-900 overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
              Taxi <span className="text-primary-300">Den Haag</span>, Leiden & Schiphol
            </h2>
            <p className="text-xl text-white/70 max-w-2xl mx-auto">
              Taxi service in heel Zuid-Holland. Den Haag, Leiden, Delft, Scheveningen en Schiphol transfers.
            </p>
          </div>
            ...
            {locations.slice(0, 8).map((location, index) => {
              ...
              return (
                <Link
                  ...
                  className="group relative bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all duration-300 overflow-hidden"
                >
                  {/* Hover gradient */}
                  ...
                  <div className="relative z-10 flex flex-col items-center text-center">
                    ...
                    <h3 className="font-bold text-white text-lg mb-1 group-hover:text-primary-300 transition-colors">
                      {location.name}
                    </h3>
                    <p className="text-sm text-white/50">{location.region}</p>

                    {/* Arrow indicator */}
                    <div className="mt-4 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0">
                      <span className="inline-flex items-center text-xs font-medium text-primary-300">
                        Bekijk tarieven
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  ...
                  <div className="flex items-center gap-3 p-4 bg-amber-50 rounded-xl border border-amber-100">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-secondary-500">Google Reviews</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {[
              {
                ...
                answer: 'U kunt bellen naar +31 6 1234 5678, WhatsAppen of het contactformulier invullen. Wij reageren binnen 15 minuten met een vaste prijs.',
              },
              {
              ...
              mainEntity: [
                {
                  ...
                  acceptedAnswer: {
                    '@type': 'Answer',
                    text: 'U kunt bellen naar +31 6 1234 5678, WhatsAppen of het contactformulier invullen. Wij reageren binnen 15 minuten met een vaste prijs.',
                  },
                },
                {
                  '@type': 'Question',
