            ...
            <div className="flex flex-wrap gap-6 items-center">
              <div className="flex items-center gap-2">
                <div className="flex -space-x-1">
                  {[...Array(5)].map((_, i) => (
                    <svg key={i} className="w-5 h-5 text-primary-300" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-white/70">Tevreden klanten</span>
              </div>
            </div>
          </div>
              ...
              >
                ...
                <defs>
                  ...
                  <linearGradient id="roofGradient" x1="0" y1="0" x2="0" y2="1">
                    ...
                    <stop offset="100%" stopColor="#0077DD" />
                  </linearGradient>
                ...
                {/* Door line */}
                <line x1="40" y1="22" x2="40" y2="32" stroke="#003366" strokeWidth="0.5" />
                ...
                <circle cx="68" cy="22" r="2" fill="#0066CC" stroke="#00AAFF" strokeWidth="0.5" />
